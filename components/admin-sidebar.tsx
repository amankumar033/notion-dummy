...
const navigation = [
  ...
  { name: "Tasks", href: "/app/admin/tasks", icon: CheckSquare },
  { name: "Employees", href: "/app/admin/employees", icon: Users },
  { name: "Teams", href: "/app/admin/teams", icon: Users2 },
  { name: "Chat", href: "/app/admin/chat", icon: MessageCircle },
  ...
  return (
    <div className="flex h-screen w-80 flex-col bg-gradient-to-b from-white via-blue-50/20 to-white border-r border-gray-200/80 bg-white/95 backdrop-blur-xl shadow-xl">
      ...
      <div className="flex h-24 items-center border-b border-gray-200/80 px-8 bg-gradient-to-r from-white to-blue-50/30">
        <Link href="/app/admin/dashboard" className="flex items-center space-x-4 group">
