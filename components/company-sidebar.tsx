...
const navigation = [
  { name: "Dashboard", href: "/app/cmp/dashboard", icon: LayoutDashboard },
  { name: "Admins", href: "/app/cmp/admins", icon: Users },
  { name: "Employees", href: "/app/cmp/employees", icon: UserCheck },
  { name: "Tasks", href: "/app/cmp/tasks", icon: CheckSquare },
  { name: "Billing", href: "/app/cmp/billing", icon: CreditCard },
  { name: "Settings", href: "/app/cmp/settings", icon: Settings },
]
  ...
  return (
    <div className="flex h-screen w-80 flex-col bg-gradient-to-b from-white via-blue-50/20 to-white border-r border-gray-200/80 bg-white/95 backdrop-blur-xl shadow-xl">
      ...
      <div className="flex h-24 items-center border-b border-gray-200/80 px-8 bg-gradient-to-r from-white to-blue-50/30">
        <Link href="/app/cmp/dashboard" className="flex items-center space-x-4 group">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium">Company Portal</p>
          </div>
        </Link>
      </div>
