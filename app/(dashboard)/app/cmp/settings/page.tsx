...
import { Settings as SettingsIcon, Save, Building2, Mail, Lock } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50/30 via-white to-cyan-50/30">
      <div className="container py-8 space-y-8 px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="text-gray-600 text-xl font-medium">Manage your company settings</p>
        </div>
        ...
        <Card className="shadow-lg border-gray-200/80 bg-gradient-to-br from-white to-blue-50/20 backdrop-blur-sm border-0">
          <CardHeader>
            ...
            <CardDescription>Update your company password</CardDescription>
          </CardHeader>
          <CardContent>
